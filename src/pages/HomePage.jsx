          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border bg-card p-8 relative overflow-hidden">
              ...
              <div className="rounded-lg bg-muted p-4 mb-6 font-mono text-sm space-y-2">
                <div className="text-muted-foreground">$ npm install -g openaether-cli</div>
                <div className="text-muted-foreground">$ openaether setup</div>
                <div className="text-aether-500">$ openaether chat</div>
              </div>
              <ul className="space-y-2 mb-6">
