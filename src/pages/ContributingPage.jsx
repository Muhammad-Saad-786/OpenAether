...
const contributionWays = [
  ...
  },
  {
    ...
    links: [
      {
        label: 'Submit pull requests',
        href: 'https://github.com/Muhammad-Saad-786/openaether/pulls',
      },
      {
        label: 'Improve documentation',
        href: 'https://github.com/Muhammad-Saad-786/openaether/wiki',
      },
    ],
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl gradient-text">
              Contribute to OpenAether
            </h1>
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground max-w-2xl mx-auto">
              Join the open source movement and help democratize AI access for everyone. Every
              contribution matters, big or small.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground">Choose how you want to help.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {contributionWays.map((way) => {
              ...
              return (
                <div
                  key={way.title}
                  className="rounded-2xl border bg-card p-8 transition-all duration-300 hover:border-aether-500/30 hover:shadow-lg"
                >
                    ...
                    {way.links.map((link) => (
                      <li key={link.label}>
                        <a
                          ...
                          className="text-sm text-aether-500 hover:underline inline-flex items-center gap-1"
                        >
                          {link.label}
                          <span>→</span>
                        </a>
            ...
            {[
              {
                step: '1',
                title: 'Fork',
                desc: 'Fork the repository on GitHub',
                icon: GitPullRequest,
              },
              { step: '2', title: 'Clone', desc: 'Clone your fork locally', icon: Code2 },
              { step: '3', title: 'Create', desc: 'Create a new branch', icon: Sparkles },
              { step: '4', title: 'Submit', desc: 'Open a pull request', icon: Heart },
            ].map((item) => {
              ...
              return (
                <div key={item.step} className="text-center rounded-2xl border bg-card p-6">
                  ...
                  <div className="text-sm font-bold text-aether-500 mb-1">Step {item.step}</div>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground">Technologies we use in OpenAether.</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {techStack.map((tech) => (
              <span
                key={tech}
                className="rounded-full bg-muted px-4 py-2 text-sm font-medium text-muted-foreground hover:bg-aether-500/10 hover:text-aether-500 transition-colors cursor-default"
              >
                {tech}
              </span>
            ))}
